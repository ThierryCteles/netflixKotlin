...
import com.teles.netflix.kotlin.model.Category
import com.teles.netflix.kotlin.model.Movie
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Requisição da Api (Lista de Filmes)
    ...
    private inner class CategoryHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(category: Category) = with(itemView) {
            recycler_view_movie.adapter = MovieAdapter(category.movies) { movie ->
                ...
                } // Apenas até a terceira opção, por enquanto hehe
